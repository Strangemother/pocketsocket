        ...
        if self.handshaked is False:
            ...
            if not data:
                ...
                if len(self.headerbuffer) >= self.maxheader:
                    self.handleError('header exceeded allowable size')
                ...
                if b'\r\n\r\n' in self.headerbuffer:
                    ...
                    try:
                        ...
                        self.handleError('handshake failed: %s', str(e),)
...
class SimpleWebSocketServer(object):
    ...
    def serve_hook(self, rList, wList):
      pass
        ...
        while self.served():
            ...
            for ready in wList:
                ...
                try:
                    ...
                    self.handleError('An Exception', n, client)
                ...
                if failed == self.serversocket:
                    ...
                    try:
                        ...
                        try:
                            ...
                            self.handleError('Could not handleClose in failed client list', client=client)


                        try:
                            self.listeners.remove(failed)
                        except:
                            self.handleError('could not remove listener of a failed client', client=client)

                    except:
                        self.handleError('Could not close a failed client connection', client=client)
